...
author: "Seijung Kim, some parts of code adapted from EDA demo by Zachary Quinn"
output:
...
```{r}
# See what it looks like when adjusting the scale of stress level curve
EDA_plot = ggplot(Recording, aes(x=TimeElapsed)) + 
...
```{r}
# Create plots of the sensor recordings
