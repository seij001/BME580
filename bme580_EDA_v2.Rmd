...
library(patchwork)
library(hms)
library(e1071)  # for stat analysis
```
...
# Load data
DataRead <- read.csv("data_train_woMiss.csv")
head(DataRead, 10)
```

```{r}
# Creating new Correlation Matrices, also include missing stress level data
# Also get summary statistics

# Select numeric variables
numeric_df = DataRead %>% dplyr::select(c(EDA_Mean, EDA_Std, EDA_Num_Peaks, 
                                   HR_Mean, HR_Std, Temp_Mean, Temp_Std, Acc1_Mean,
                                   Acc1_Std, Acc2_Mean, Acc2_Std, Acc3_Mean, Acc3_Std, Stress_level))
# numeric_df = numeric_df %>% drop_na()
head(numeric_df, 10)

# 0. For missing stress levels
miss_stress <- filter(numeric_df, Stress_level == "Missing")
miss_stress = miss_stress %>% dplyr::select(c(EDA_Mean, EDA_Std, EDA_Num_Peaks, 
                                   HR_Mean, HR_Std, Temp_Mean, Temp_Std, Acc1_Mean,
                                   Acc1_Std, Acc2_Mean, Acc2_Std, Acc3_Mean, Acc3_Std))
...
all_stress = all_stress %>% dplyr::select(c(EDA_Mean, EDA_Std, EDA_Num_Peaks, 
                                   HR_Mean, HR_Std, Temp_Mean, Temp_Std, Acc1_Mean,
                                   Acc1_Std, Acc2_Mean, Acc2_Std, Acc3_Mean, Acc3_Std))
...
no_stress = no_stress %>% dplyr::select(c(EDA_Mean, EDA_Std, EDA_Num_Peaks, 
                                   HR_Mean, HR_Std, Temp_Mean, Temp_Std, Acc1_Mean,
                                   Acc1_Std, Acc2_Mean, Acc2_Std, Acc3_Mean, Acc3_Std))
...
low_stress = low_stress %>% dplyr::select(c(EDA_Mean, EDA_Std, EDA_Num_Peaks, 
                                   HR_Mean, HR_Std, Temp_Mean, Temp_Std, Acc1_Mean,
                                   Acc1_Std, Acc2_Mean, Acc2_Std, Acc3_Mean, Acc3_Std))
...
high_stress = high_stress %>% dplyr::select(c(EDA_Mean, EDA_Std, EDA_Num_Peaks, 
                                   HR_Mean, HR_Std, Temp_Mean, Temp_Std, Acc1_Mean,
                                   Acc1_Std, Acc2_Mean, Acc2_Std, Acc3_Mean, Acc3_Std))
...
```{r}
# Get summary statistics for EDA distribution
print("Missing stress level")
summary(miss_stress)
skewness(miss_stress$EDA_Mean)
kurtosis(miss_stress$EDA_Mean)

print("All stress level")
summary(all_stress)
skewness(all_stress$EDA_Mean)
kurtosis(all_stress$EDA_Mean)

print("No stress level")
summary(no_stress)
skewness(no_stress$EDA_Mean)
kurtosis(no_stress$EDA_Mean)

print("Low stress level")
summary(low_stress)
skewness(low_stress$EDA_Mean)
kurtosis(low_stress$EDA_Mean)

print("High stress level")
summary(high_stress)
skewness(high_stress$EDA_Mean)
kurtosis(high_stress$EDA_Mean)
```