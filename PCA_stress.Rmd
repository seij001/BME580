...
Copied from demo in class, use this analysis on the stress data
...
data = subset(data, select = -c(X,Timestamp,Unnamed..0, Unnamed..0.1) )
...
data = data %>% drop_na(Stress_level)
...
```{r}
ivs = data %>% select(-c(Stress_level,sID))
